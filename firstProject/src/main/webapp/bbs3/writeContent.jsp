...
// db 삽입하기
String sql_insert = "insert into "+code+" (id,name,title,issueDate,attach,attachRe)";
		sql_insert += " values ('"+session_id+"','"+session_name+"','"+title+"','"+issueDate+"','"+attach_name+"','"+attach_rename+"')";
...
<script>
	location.href="/bbs3/list.jsp?code=<%=code%>";
</script>
