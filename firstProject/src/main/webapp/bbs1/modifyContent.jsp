...
if(attach_name != null && attach_name != "") { // 첨부파일이 있다면
	sql_modify = "update "+code+" set title='"+title+"',context='"+context+"',issueDate='"+issueDate+"',attach='"+attach_rename+"',";
	sql_modify += "attachRe='"+attach_name+"',thumbNail='"+attach_thumb+"' where no='"+no;
}
else {
	sql_modify = "update "+code+" set title='"+title+"',context='"+context+"', issueDate='"+issueDate+"'";
}
