...
<table class="bodyFrame">
	<tr>
		<td align=center>[민원과 답변]</td>
	</tr>
	<tr>
		<td>
			<form name="#" action="writeContent.jsp" method="post">
			<input type="hidden" name="code" value="<%=code%>">
				<table class="bodyFrame">
					<tr><td colspan=2 style="border-top:1px solid black"></td></tr>
					<tr>
						<td align=center height=28>옵션</td>
						<td>
							<%if(session_level != null && session_level.equals("3")){ // 관리자 %>
							<input type="radio" name="inform" value="1">공지
							<%} %> 
