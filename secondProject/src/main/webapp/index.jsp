...
<ul>
	...
	<li><a href="/">홈</a></li>
	<li class="selected"><a href="https://blog.naver.com/corean5">블로그</a></li>
	<li><a href="/item/list">상품목록</a></li>
	<li><a href="/cart/list">장바구니</a></li>
	<li><a href="https://cafe.naver.com/coffeetreeraise">커뮤니티</a></li>
	<li><a href="directions.jsp">위치</a></li>
	<c:choose>
